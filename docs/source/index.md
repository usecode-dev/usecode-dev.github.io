...
> You still need to care about the software if not resilience!
...
We recommend using UseCode .Dev guidelines and principles to realize the core principle of "use is dev and/or dev is use". To help users and developers use and develop technology and software.
We need to focus on building core tools that help us achieve this ideal. We always prioritize the core guidelines of UseCode .Dev in our decisions.
...
We surrender ourselves to UseCode.dev's principle as a tech community, Because it is a great reality and opportunity. Join us as a technology user and as a technology developer.
